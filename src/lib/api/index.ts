import type { Team, Member, Project, MemberProject } from '@/types';
...
// MemberProject API
export const createMemberProject = (memberProject: MemberProject) => api.post('/member_projects', memberProject);
